...
export default function Home() {
  ...
  return (
    <>
      ...
      <main
        className={`flex min-h-screen w-full flex-col items-center bg-gradient-to-b from-[#2e026d] to-[#15162c] py-8 ${
          sessionData ? "" : "justify-center"
        }`}
      >
        <div className="mx-auto flex w-full max-w-3xl flex-col items-center justify-center gap-12 px-4 py-16 ">
          ...
          <div className="w-full ">{sessionData && <ProtectedCanvas />}</div>
        </div>
      </main>
    </>
  );
